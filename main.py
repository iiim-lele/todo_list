...
class AppToDo:
    def __init__(self, page: ft.Page):
        # Inicia o aplicativo com a página Flet e configura as configurações iniciais
        self.page = page
    ...
    def verificar_usuario(self):
        # Verifica se o usuário já foi definido, caso contráriom pede o nome
    ...
    def criar_abas(self):
        ...
        self.abas = ft.Tabs(
            ...
            tabs=[
                ft.Tab(text="Todos", icon=ft.Icons.LIST),
    ...
    def atualizar_lista_tarefas(self, e=None):
        # Atualiza a lista de tarefas com base na aba selecionda
    ...
    def alternar_status_tarefa(self, e, tarefa):
        # Alternar o status de uma tarefa entre completa e incompleta
